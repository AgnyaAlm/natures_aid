...
public class SetReputationCommand {
	...
	public static void registerCommand(RegisterCommandsEvent event) {
		event.getDispatcher()
				.register(Commands.literal("setecorep").requires(s -> s.hasPermission(4))
						.then(Commands.argument("arguments", StringArgumentType.greedyString()).executes(SetReputationCommand::execute))
						.executes(SetReputationCommand::execute));
	}
