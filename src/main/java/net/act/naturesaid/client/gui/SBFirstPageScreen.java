...
public class SBFirstPageScreen extends AbstractContainerScreen<SBFirstPageMenu> {
	...
	private static final ResourceLocation texture = new ResourceLocation("natures_aid:textures/sb_first_page.png");
	...
	protected void renderBg(PoseStack ms, float partialTicks, int gx, int gy) {
		...
		RenderSystem.setShaderTexture(0, new ResourceLocation("natures_aid:textures/base.png"));
