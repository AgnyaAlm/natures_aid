...
import net.act.naturesaid.network.MortarGUIButtonMessage;
...
public class MortarGUIScreen extends AbstractContainerScreen<MortarGUIMenu> {
	...
	private static final ResourceLocation texture = new ResourceLocation("natures_aid:textures/mortar_gui.png");
	...
	public void init() {
		...
		this.addRenderableWidget(new Button(this.leftPos + 0, this.topPos + 56, 40, 20, new TextComponent("Mix"), e -> {
			if (true) {
				NaturesAidMod.PACKET_HANDLER.sendToServer(new MortarGUIButtonMessage(0, x, y, z));
