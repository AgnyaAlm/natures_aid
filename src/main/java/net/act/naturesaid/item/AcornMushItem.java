...
import net.act.naturesaid.procedures.AcornMushFoodEatenProcedure;
import net.act.naturesaid.init.NaturesAidModTabs;

public class AcornMushItem extends Item {
	public AcornMushItem() {
	...
	public ItemStack finishUsingItem(ItemStack itemstack, Level world, LivingEntity entity) {
		...
		AcornMushFoodEatenProcedure.execute(entity);
