...
import net.act.naturesaid.procedures.CoconutBreakProcedure;
...
public class CoconutItem extends Item {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("\u00A77Right-Click to break the coconut."));
	}
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		CoconutBreakProcedure.execute(world, x, y, z, itemstack);
		return ar;
	}
}
