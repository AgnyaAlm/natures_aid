	...
	public static void execute(LevelAccessor world, double x, double y, double z) {
		if ((world.getBlockState(new BlockPos((int) x, (int) (y + 1), (int) z))).getBlock() == Blocks.OAK_LEAVES) {
			if (Math.random() <= 0.7) {
				...
				}.getAmount(world, new BlockPos((int) x, (int) y, (int) z), 0) <= 15) {
					{
						BlockEntity _ent = world.getBlockEntity(new BlockPos((int) x, (int) y, (int) z));
						if (_ent != null) {
							final int _slotid = 0;
							final ItemStack _setstack = new ItemStack(NaturesAidModItems.SMALL_LEAF.get());
				...
				}.getAmount(world, new BlockPos((int) x, (int) y, (int) z), 1) <= 15) {
					{
						BlockEntity _ent = world.getBlockEntity(new BlockPos((int) x, (int) y, (int) z));
						if (_ent != null) {
							final int _slotid = 1;
							final ItemStack _setstack = new ItemStack(NaturesAidModItems.MAPLE_LEAF.get());
							_setstack.setCount((int) (new Object() {
								public int getAmount(LevelAccessor world, BlockPos pos, int slotid) {
									AtomicInteger _retval = new AtomicInteger(0);
									BlockEntity _ent = world.getBlockEntity(pos);
				...
				}.getAmount(world, new BlockPos((int) x, (int) y, (int) z), 2) <= 15) {
					{
						BlockEntity _ent = world.getBlockEntity(new BlockPos((int) x, (int) y, (int) z));
						if (_ent != null) {
							final int _slotid = 2;
				...
				if (world instanceof ServerLevel _level)
					_level.sendParticles(NaturesAidModParticles.LEAFPARTICLE, x, y, z, 3, 1, 1, 1, 1);
				...
				}.getAmount(world, new BlockPos((int) x, (int) y, (int) z), 4) <= 15) {
					{
						BlockEntity _ent = world.getBlockEntity(new BlockPos((int) x, (int) y, (int) z));
						if (_ent != null) {
							final int _slotid = 4;
				...
				if (world instanceof ServerLevel _level)
					_level.sendParticles(NaturesAidModParticles.LEAFPARTICLE, x, y, z, 2, 1, 1, 1, 1);
			} else {
				if (new Object() {
					public int getAmount(LevelAccessor world, BlockPos pos, int slotid) {
						AtomicInteger _retval = new AtomicInteger(0);
					...
					if ((world.getBlockState(new BlockPos((int) x, (int) (y + 1), (int) z))).getBlock() == Blocks.JUNGLE_LEAVES) {
					...
					} else {
						{
							...
							if (_ent != null) {
								final int _slotid = 3;
								final ItemStack _setstack = new ItemStack(NaturesAidModItems.ACORN.get());
								_setstack.setCount((int) (new Object() {
									public int getAmount(LevelAccessor world, BlockPos pos, int slotid) {
										AtomicInteger _retval = new AtomicInteger(0);
										BlockEntity _ent = world.getBlockEntity(pos);
			...
			if (Math.random() <= 0.7) {
				...
				if (new Object() {
					...
					if ((world.getBlockState(new BlockPos((int) x, (int) (y + 2), (int) z))).getBlock() == Blocks.JUNGLE_LEAVES) {
						{
							BlockEntity _ent = world.getBlockEntity(new BlockPos((int) x, (int) y, (int) z));
							if (_ent != null) {
								final int _slotid = 3;
